...
const Page = () => {
  ...
  const { mutate, isLoading } = trpc.auth.createPayloadUser.useMutation({
    ...
    onSuccess: ({ sentToEmail }) => {
      toast.success(`An email has been sent to ${sentToEmail} for verification.`)
      ...
      <div className="container relative flex pt-20 flex-col items-center justify-center lg:px-0">
        <div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
          <div className="flex flex-col items-center space-y-2 text-center">
            ...
            <a className={buttonVariants({ variant: 'link', className: 'text-blue-500 dark:text-red-500 gap-1.5' })} href='/login'>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className="grid gap-2">
                <div className="grid gap-1 py-2">
                  ...
                  <Input {...register("email")} autoComplete="off" className={cn({ "focus-visible:ring-red-500": errors.email })} placeholder="example@redeye.com" />
