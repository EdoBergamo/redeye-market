...
export const ReceiptEmail = ({ email, date, orderId, products }: ReceiptEmailProps) => {
  ...
  return (
    <Html>
      <Head />
      <Preview>Your RedEye Receipt</Preview>
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section>
            ...
            <Column style={productPriceWrapper} align='right'>
              <Text style={productPrice}>{formatPrice(0)}</Text>
            </Column>
          </Section>
...
export const ReceiptEmailHtml = (props: ReceiptEmailProps) => render(<ReceiptEmail {...props} />, {
  pretty: true,
})
