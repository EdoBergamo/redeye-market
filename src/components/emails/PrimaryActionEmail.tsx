import { Body, Hr, Html, Img, Head, Preview, Container, Section, Text, Button, render, } from '@react-email/components'
...
export const EmailTemplate = ({ actionLabel, buttonText, href }: EmailTemplateProps) => {
  return (
    <Html>
      <Head />
      <Preview>The marketplace for high-quality cheats.</Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={paragraph}>
            Welcome to RedEye, the marketplace for high quality digital
