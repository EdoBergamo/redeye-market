...
var isAdminOrHasAccessToProducts = function () { return function (_a) {
    var req = _a.req;
    return __awaiter(void 0, void 0, void 0, function () {
        var user;
        return __generator(this, function (_b) {
...
exports.Products = {
    ...
    access: {
        read: isAdminOrHasAccessToProducts(),
        create: isAdminOrHasAccessToProducts(),
        update: isAdminOrHasAccessToProducts(),
    },
    fields: [
        {
            name: "user",
        ...
        },
        {
            ...
            label: "Category",
            type: "select",
            options: config_1.PRODUCT_CATEGORY.map(function (_a) {
