...
var youOwnAndPurchased = function (_a) {
    var req = _a.req;
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    orders = (_b.sent()).docs;
                    purchasedProductFileIds = orders.map(function (order) {
                        return order.products.map(function (prod) {
                            if (typeof prod === 'string')
                                return req.payload.logger.error("Cannot Find purchased product file with id ".concat(prod));
