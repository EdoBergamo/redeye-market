...
var ReceiptEmail = function (_a) {
    ...
    var total = products.reduce(function (acc, product) { return acc + product.price; }, 0) + 0;
    var year = new Date().getFullYear();
    return (React.createElement(components_1.Html, null,
        React.createElement(components_1.Head, null),
        React.createElement(components_1.Preview, null, "Your RedEye Receipt"),
        React.createElement(components_1.Body, { style: main },
            React.createElement(components_1.Container, { style: container },
                React.createElement(components_1.Section, null,
                    React.createElement(components_1.Column, null,
                        React.createElement(components_1.Img, { src: "".concat(process.env.NEXT_PUBLIC_SERVER_URL, "/hippo-email-sent.png"), width: '100', height: '100', alt: 'RedEye' })),
                ...
                React.createElement(components_1.Section, null,
                    ...
                    React.createElement(components_1.Column, { style: productPriceWrapper, align: 'right' },
                        React.createElement(components_1.Text, { style: productPrice }, (0, utils_1.formatPrice)(0)))),
...
var ReceiptEmailHtml = function (props) { return (0, components_1.render)(React.createElement(exports.ReceiptEmail, __assign({}, props)), {
    pretty: true,
}); };
